...
#+begin_src emacs-lisp :tangle lisp/packages.el
  ...
  ;; Define the function to set Treemacs icon size and resize icons
  (defun my-treemacs-set-icon-size ()
    "Set Treemacs icon size to 16 and resize icons."
    (treemacs-resize-icons 16))

  ;; Add the function to the treemacs-mode-hook
  (add-hook 'treemacs-mode-hook 'my-treemacs-set-icon-size)
  ...
  (dolist (face '(treemacs-root-face
                    ...
                    treemacs-file-face
                    treemacs-tags-face))
      (set-face-attribute face nil :family "SF Pro" :height 130))
#+end_src
