c#+begin_src emacs-lisp :tangle lisp/common.el
...
** LSP
#+begin_src emacs-lisp :tangle lisp/hooks.el
  (setq package-selected-packages '(lsp-mode lsp-ui yasnippet lsp-treemacs company hydra avy which-key dap-mode))
